...
./build/V%__ALLcls.o: $(VERSAT_HW_DIR)/src/%.v
	verilator --trace -CFLAGS "-g -m32 -std=c++11" -I$(VERSAT_HW_DIR)/src -I$(VERSAT_HW_DIR)/include -I$(MEM_DIR)/hardware/ram/2p_ram -I$(MEM_DIR)/hardware/ram/tdp_ram -cc -Mdir ./obj $<;
	cd ./obj && make -f V$*.mk;
