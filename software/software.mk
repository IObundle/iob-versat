...
./build/verilated.o:
	mkdir -p ./build;
	g++ -std=c++11 -I. -MMD -I/usr/local/share/verilator/include -I/usr/local/share/verilator/include/vltstd -DVL_PRINTF=printf \
...
./build/V%__ALLcls.o: $(VERSAT_HW_DIR)/src/%.v
	verilator -CFLAGS "-g -m32 -std=c++11" -I$(VERSAT_HW_DIR)/src -I$(VERSAT_HW_DIR)/include -I$(MEM_DIR)/ram/2p_ram -I$(CACHE_DIR)/submodules/MEM/tdp_ram -cc -Mdir ./obj $<;
	cd ./obj && make -f V$*.mk;
